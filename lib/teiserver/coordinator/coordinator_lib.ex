defmodule Teiserver.Coordinator.CoordinatorLib do
  ...
  def help(user, host, command) do
    commands = [
      ...
      {"teamstats", ["user"], "Show team rating info about the user specified. Leave <user> blank to get your own info.", :everybody},
      {"duelstats", ["user"], "Show duel rating info about the user specified. Leave <user> blank to get your own info.", :everybody},
      {"ffastats", ["user"], "Show FFA rating info about the user specified. Leave <user> blank to get your own info.", :everybody},
...
> friendsplay: allows only friends of existing players to become players (but anybody can join to spectate)",
      ...
      {"setratinglevels", ["min-level", "max-level"],
       ...
       "Sets the minimum chevron requirement for players. Requires boss privileges.",
       :everybody},
      {"maxchevlevel", ["max-level"],
       "Sets the maximum chevron requirement for players. Requires boss privileges.",
       :everybody},
       {"resetchevlevels", [],
       "Resets chevron requirement for players. Requires boss privileges.",
       :everybody},
